...
// document.write(`<div class="container" style="display: flex; width: 100%; flex-wrap: wrap">`)
// for (let i = 0; i < usersList.length; i++) {
//     document.write(`<div class="users-box" style="">
//         <div class="user-block" style=" background-color: aquamarine; text-align: center; padding: 10px;
//         margin: 10px; height: 300px;width: 800px;">
//         <h2>${usersList[i].id} - ${usersList[i].name} - ${usersList[i].name}</h2>
...
// document.write(`<div class="container" style="width: 1800px; display: flex; flex-wrap: wrap">`)
// for (let i = 0; i < arr.length; i++) {
//     document.write(`<div class="wrap" style="margin: 10px;">
//         <div class="post-card" style="max-width: 300px; padding: 10px; border: 5px solid black; height: 300px;">
//         <h3 style="text-align: center">${arr[i].id} ${arr[i].title}</h3>
//         <p style="text-align: left">${arr[i].body}</p>
//     </div>
//     </div>`)
// }
